defmodule SciEx.Float64.Array1 do
  ...
  use SciEx.FloatArrayModuleBuilder, bits: 64, dim: 1
  ...
  def linspace(start, stop, n) when is_integer(n) and n >= 0 do
    SciExNif.float64_array1_linspace(start, stop, n)
  end
  ...
  def geomspace(start, stop, n) when is_integer(n) and n >= 0 do
    case SciExNif.float64_array1_geomspace(start, stop, n) do
      {:ok, array} ->
        array
  ...
  def logspace(base, start, stop, n) when is_integer(n) and n >= 0 do
    SciExNif.float64_array1_logspace(base, start, stop, n)
  end
end
