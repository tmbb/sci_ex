defmodule SciEx.Float32.Array5 do
  ...
  SciEx.ArrayHelpers.bind_comparison_array_ops_to_sci_nifs(__MODULE__, :float32_array5)

  @doc """
  Creates an array os zeros (`0.0`) with the given dimensions.
  """
  def zeros(n1, n2, n3, n4, n5), do: SciExNif.float32_array5_zeros(n1, n2, n3, n4, n5)

  @doc """
  Creates an array os ones (`1.0`) with the given dimensions.
  """
  def ones(n1, n2, n3, n4, n5), do: SciExNif.float32_array5_ones(n1, n2, n3, n4, n5)
  ...
  defimpl Inspect do
    ...
    def inspect(array5, _opts) do
      IAlgebra.concat([
        ...
        SciExNif.float32_array5_inspect(array5),
        ">"
      ])
    end
  end
