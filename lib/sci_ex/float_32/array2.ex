defmodule SciEx.Float32.Array2 do
  @moduledoc """
  2D Array of 32it floating points
  """
  ...
  SciEx.ArrayHelpers.bind_comparison_array_ops_to_sci_nifs(__MODULE__, :float32_array2)

  @doc """
  Creates an array os zeros (`0.0`) with the given dimensions.
  """
  def zeros(n1, n2), do: SciExNif.float32_array2_zeros(n1, n2)

  @doc """
  Creates an array os ones (`1.0`) with the given dimensions.
  """
  def ones(n1, n2), do: SciExNif.float32_array2_ones(n1, n2)
  ...
  defimpl Inspect do
    ...
    def inspect(array2, _opts) do
      IAlgebra.concat([
        ...
        SciExNif.float32_array2_inspect(array2),
        ">"
      ])
    end
  end
