defmodule SciEx.Gen.FloatVectorizer do
  alias SciEx.Gen.{
    RustFloatModule,
    Function,
    VectorizedArgument
  ...
  def vectorize_function(%RustFloatModule{} = rust_module, function) do
    functions =
  ...
  EEx.function_from_file(
    ...
    "scripts/rust_generator/templates/vectorized_function.rs",
    [:assigns]
  )

  @external_resource "scripts/rust_generator/templates/vectorized_function_one_arg.rs"

  EEx.function_from_file(
    :def,
    :vectorized_function_one_arg_rs,
    "scripts/rust_generator/templates/vectorized_function_one_arg.rs",
    [:assigns]
  )

  @external_resource "scripts/rust_generator/templates/scalar_function.rs"

  EEx.function_from_file(
    :def,
    :scalar_function_rs,
    "scripts/rust_generator/templates/scalar_function.rs",
    [:assigns]
  )
