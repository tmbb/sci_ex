defmodule SciEx.Gen.Vectorizer do
  ...
  def vectorize_function(%RustModule{} = rust_module, function) do
    functions =
  ...
  @external_resource "priv/rust_generator/templates/vectorized_function_one_arg.rs"

  EEx.function_from_file(
    :def,
    :vectorized_function_one_arg_rs,
    "priv/rust_generator/templates/vectorized_function_one_arg.rs",
    [:assigns]
  )
